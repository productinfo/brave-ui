...
// Components
import styled from '../../src/components/style/themes'
...
for (const name in theme.color) {
  // @ts-ignore
  allBraveDefaultItems.push({ name, color: theme.color[name] })
}
...
storiesOf('Components/Style', module)
  ...
  .addWithChapters('Theme Variables', {
    subtitle:
      'Define colors, fonts, and sizes by purpose. Keys should not describe the value, but what they are to be used for.',
    chapters: [
      {
        sections: [
          {

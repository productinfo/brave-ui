...
export class TinyColor {
  ...
  /*
   * This is the magic formula for generating
   * Brave color palette scales from single HEX values
   */
  makeColor = function (color: ColorInput, index: number) {
    const hueStep = 2
  ...
  toPercentageRgbString () {
    ...
    return this.a === 1
      ...
      : `rgba(${rnd(this.r)}%, ${rnd(this.g)}%, ${rnd(this.b)}%, ${
          this.roundA
        })`
  }
  /**
